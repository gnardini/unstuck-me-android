...
import ar.com.wolox.unstuckme.listener.OnPageSelectedListener;
...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    public SlidingTabLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        mTitleOffset = (int) getResources().getDimension(R.dimen.title_offset);
        mTabStrip = new SlidingTabStrip(context);

        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.SlidingTabs);
        if (typedArray == null) return;
        mTabTextColor = typedArray.getColor(R.styleable.SlidingTabs_textColor, R.color.white);
    ...
    protected TextView createDefaultTabView(Context context) {
        ...
        textView.setTextSize(TypedValue.COMPLEX_UNIT_SP, getResources().getDimension(
                R.dimen.tab_view_text_size));
        textView.setTextColor(mTabTextColor);
        textView.setSingleLine(true);
        textView.setAllCaps(true);
        textView.setCustomFont(getContext().getString(R.string.font_open_sans_regular));
        ...
        int padding = (int) getResources().getDimension(R.dimen.tab_view_padding);
